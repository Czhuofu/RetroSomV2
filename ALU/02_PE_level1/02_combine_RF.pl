...
my $sample = $ARGV[3];
my $m1_file = $workfolder.'/'.$sample.'/'.$retro.'/'.$sample.'.pe.ALU.matrix';
my $g1_file  = $workfolder.'/'.$sample.'/'.$retro.'/ALU/'.$sample.'.pe.pred.A1.txt';
my $g2_file  = $workfolder.'/'.$sample.'/'.$retro.'/ALU/'.$sample.'.pe.pred.A2.txt';
my $ou1_file = $workfolder.'/'.$sample.'/'.$retro.'/ALU/'.$sample.'.pe2.pred.all.txt';
my $ou2_file = $workfolder.'/'.$sample.'/'.$retro.'/ALU/'.$sample.'.pe2.pred.summary';
my @order = (1,2); 
