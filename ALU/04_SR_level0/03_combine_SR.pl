...
my $ou1_file = $workfolder.'/'.$sample.'/'.$retro.'_0/ALU/'.$sample.'.sr1.pred.all.txt';
my $ou2_file = $workfolder.'/'.$sample.'/'.$retro.'_0/ALU/'.$sample.'.sr1.pred.summary';
my $ou3_file = $workfolder.'/'.$sample.'/'.$retro.'_1/ALU/'.$sample.'.sr1.pred.all.txt';
my $ou4_file = $workfolder.'/'.$sample.'/'.$retro.'_1/ALU/'.$sample.'.sr1.pred.summary';
my @order = (1); 
