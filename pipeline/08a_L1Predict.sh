...
Rscript $masterpath/LINE/06_Predict/01.Model.Stacking.r $outpath $ver $sub $masterpath
$masterpath/LINE/06_Predict/02_post_filtering.pl $outpath $ver $sub $cont $masterpath $hg $pcutoff
$masterpath/LINE/06_Predict/04_plot_L1.pl $outpath $sub $ver 0.1 $masterpath $hg
