...
my $sample = $ARGV[3];
my $m1_file  = $workfolder.'/'.$sample.'/'.$retro.'/'.$sample.'.pe.LINE.matrix';
my $g1_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G1.txt';
my $g2_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G2.txt';
my $g3_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G3.txt';
my $g4_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G4.txt';
my $g5_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G5.txt';
my $g6_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G6.txt';
my $g7_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G7.txt';
my $g8_file  = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe.pred.G8.txt';
my $ou1_file = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe2.pred.all.txt';
my $ou2_file = $workfolder.'/'.$sample.'/'.$retro.'/LINE/'.$sample.'.pe2.pred.summary';
