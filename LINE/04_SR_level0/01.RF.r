...
filename <- paste(as.character(datpath),"/",as.character(sub),"/list.txt", sep="")
...
for (i in 1:dim(subs)[1])
   {
    ...
    nx2 <- test2[,c("seg", "map", "depth","map_size","map_ratio", "short","end3","end5","direction", "refpos", "dist", "A_pair", "A_insert", "A_mm", "A_MapQ", "A_AS", "A_XS", "gap")]
